...
import { ActivityIndicator, Platform, StyleSheet, TouchableOpacity, View ,Animated} from 'react-native';
import {
  BallIndicator,
  BarIndicator,
  DotIndicator,
...
// import * as Animated from 'react-native-Animated';
    ...
    case 'BallIndicator':
      return (
        <View style={{ width: width, alignItems: 'center', justifyContent: 'center' }}>
          <Animated.View animation={animationType || 'fadeIn'} style={[styles.defaultSpinnerContainerStyle, customSpinnerStyle]}>
            <BallIndicator
