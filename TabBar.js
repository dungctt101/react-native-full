...
export default class TabBar extends React.Component {
  ...
  render() {
    ...
    const {themes, navigation,imageView,coverView,menuCircleView,badge} = this.props;
    ...
    return (
      <View style={{flex: 1, flexDirection: 'column'}}>
        ...
        {!objectIsNull(badge) &&badge.num>0&& <View style={{width:badge.size,height:badge.size,position:"absolute",right:badge.right,bottom:badge.bottom,backgroundColor:badge.color,justifyContent:"center",
      alignItems:"center",borderRadius:badge.size}}><Text style={{color:"#ffffff"}}>{badge.num}</Text></View>}
          </View>
        <TabBarIcon3
tintColor={this.props.tintColor}
color={this.props.color}
